...
export function parseArgs(argv) {
  const args = { yes: false, rewire: false, force: false, uninstall: false, help: false, version: false, purge: false, update: false, tracked: false, allowActiveSessions: false, allowSelfUpdate: false };
