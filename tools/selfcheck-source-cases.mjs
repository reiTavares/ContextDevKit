...
export const SOURCE_INVARIANT_CASES = [
    ...
    ['pipeline allocates ids with exclusive create', 'templates/contextkit/tools/scripts/pipeline-add.mjs', /flag:\s*'wx'/],
    ...
    ['pipeline STAGES includes working (ADR-0015 §B)', 'templates/contextkit/tools/scripts/pipeline-transitions.mjs', /STAGES\s*=\s*\{[^}]*working:\s*'working'/],
    ['pipeline STATUS includes working', 'templates/contextkit/tools/scripts/pipeline-transitions.mjs', /STATUS\s*=\s*\{[^}]*working:\s*'working'/],
    ...
    ['pipeline writes complexity + dependencies fields (split: pipeline-add)', 'templates/contextkit/tools/scripts/pipeline-add.mjs', /complexity:\s*\$\{complexity\}/],
