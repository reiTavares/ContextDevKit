...
async function checkSourceInvariants(rep, KIT) {
  ...
  const cases = [
    ...
    ['advisor wires all six lanes to an owner (ADR-0028)', 'templates/vibekit/runtime/config/defaults.mjs', /deepen:\s*\{\s*owner:\s*'product-owner'\s*\},[\s\S]*growth:\s*\{\s*owner:\s*'growth'\s*\}/],
    ...
    ['md-extract exposes shared section() helper (ADR-0027)', 'templates/vibekit/runtime/hooks/md-extract.mjs', /export function section/],
    ['md-extract exposes firstParagraph() helper (ADR-0027)', 'templates/vibekit/runtime/hooks/md-extract.mjs', /export function firstParagraph/],
    ['session-digest-core parses a session log (ADR-0027)', 'templates/vibekit/runtime/hooks/session-digest-core.mjs', /export function parseSessionLog/],
    ['session-digest-core renders a compact digest (ADR-0027)', 'templates/vibekit/runtime/hooks/session-digest-core.mjs', /export function renderDigest/],
    ['session-digest single-sources the parser (ADR-0027)', 'templates/vibekit/tools/scripts/session-digest.mjs', /session-digest-core/],
    ['session-digest exposes --last mode (ADR-0027)', 'templates/vibekit/tools/scripts/session-digest.mjs', /--last/],
    ...
    ['boot exposes digestLatestSession (ADR-0027)', 'templates/vibekit/runtime/hooks/boot-context-readers.mjs', /export async function digestLatestSession/],
    ['boot keeps the raw extractor as a fallback (ADR-0027)', 'templates/vibekit/runtime/hooks/boot-context-readers.mjs', /export async function extractLatestSession/],
    ['boot digest degrades to raw — never empty (rule 2/8)', 'templates/vibekit/runtime/hooks/boot-context-readers.mjs', /mode:\s*'raw'/],
    ['session-start renders the session digest (ADR-0027)', 'templates/vibekit/runtime/hooks/session-start.mjs', /digestLatestSession/],
    ['context-pack reuses the boot session digest (ADR-0027)', 'templates/vibekit/tools/scripts/context-pack.mjs', /digestLatestSession/],
    ['context-pack reuses the ADR core (ADR-0027)', 'templates/vibekit/tools/scripts/context-pack.mjs', /adr-digest-core/],
    ...
    ['adr-digest-core parses an ADR (ADR-0027)', 'templates/vibekit/tools/scripts/adr-digest-core.mjs', /export function parseAdr/],
    ['adr-digest single-sources the parser (ADR-0027)', 'templates/vibekit/tools/scripts/adr-digest.mjs', /adr-digest-core/],
    ['adr-digest supports keyword search (ADR-0027)', 'templates/vibekit/tools/scripts/adr-digest.mjs', /--search/],
    ['adr-digest excludes the ADR template (ADR-0027)', 'templates/vibekit/tools/scripts/adr-digest.mjs', /_TEMPLATE\.md/],
