...
try {
  ...
  /🌀 .*\bA3\b/.test(run([join(proj, 'contextkit', 'runtime', 'statusline.mjs')], { cwd: proj }).stdout || '')
    ? ok('statusline prints the line incl. the dial badge A3 (default grade 3, ADR-0042 §6 / ADR-0058)') : bad('statusline missing the A<grade> dial badge');
