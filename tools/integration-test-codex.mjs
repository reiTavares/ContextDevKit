...
try {
  ...
  readdirSync(join(proj, '.agents', 'skills')).filter((name) => name.startsWith('source-command-')).length === 80
    ? ok('Codex installs all 80 canonical command projections (zero silent skips)')
