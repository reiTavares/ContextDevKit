...
model: sonnet
description: Senior implementation specialist for the smallest safe production diff, tests with behavior, explicit deviations, and evidence. Recommend for material code changes; never require agent presence or a packet before owner-authorized work. (devteam squad)
---
