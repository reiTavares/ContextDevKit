#!/usr/bin/env node
/**
 * Read-only project analyzer for `/setupvibedevkit`.
 *
 ...
 *
 * Usage:  node vibekit/tools/scripts/detect-stack.mjs   (prints JSON)
 */
...
function suggestLedger(sourceDirs, languages) {
  const important = new Set([...sourceDirs, 'vibekit/', '.claude/', '.github/', 'CLAUDE.md']);
