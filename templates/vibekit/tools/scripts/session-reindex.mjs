#!/usr/bin/env node
/**
 * Regenerates `vibekit/memory/SESSIONS.md` as an INDEX of the per-session
 * markdown files under `vibekit/memory/sessions/`.
 *
 ...
 *
 * Usage:  node vibekit/tools/scripts/session-reindex.mjs
...
function buildIndex(entries) {
  ...
  out.push('> Each session lives in its own file under `vibekit/memory/sessions/`.');
