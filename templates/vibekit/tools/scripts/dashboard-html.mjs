...
<title>${escapeHtml(data.meta.project)} — VibeDevKit dashboard</title>
<style>${CSS}</style>
</head><body>
<header class="topbar">
...
<footer class="footnote">VibeDevKit · ${escapeHtml(data.meta.platformDir)}/ · generated ${fmtTime(data.meta.generatedAt)}</footer>
${liveScript}
</body></html>`;
}
