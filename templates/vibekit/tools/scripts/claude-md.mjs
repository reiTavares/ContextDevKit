 ...
 *
 * Usage:
 *   node vibekit/tools/scripts/claude-md.mjs find [--json]
 *   node vibekit/tools/scripts/claude-md.mjs scaffold   # create missing (stub) CLAUDE.md
 */
...
// Installed at <project>/vibekit/tools/scripts/ → the seeded template is at <project>/vibekit/.
