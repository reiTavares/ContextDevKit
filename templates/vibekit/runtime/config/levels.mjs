/**
 * Canonical level taxonomy — the SINGLE source of truth for VibeDevKit's
 ...
 * in-project `/vibe-level` helper. Zero third-party deps (hot-path safe).
 *
...
/**
 * Human-readable label per level — the ONE table. The installer and `/vibe-level`
