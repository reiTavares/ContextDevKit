...
```bash
cp vibekit/detectors/example-detector.mjs.example vibekit/detectors/console-log.mjs
node vibekit/tools/scripts/tech-debt-scan.mjs   # now flags stray console.log calls
```
