...
export const DEFAULT_WORK_CLASSIFICATION = Object.freeze({
  ...
  businessKind: { default: 'capability', kinds: {
    capability: [ { s: 'platform', w: 2 }, { s: 'capability', w: 3 }, { s: 'engine', w: 1 }, { s: 'framework', w: 1 }, { s: 'plataforma', w: 2 }, { s: 'capacidade', w: 3 } ],
    product: [ { s: 'product', w: 3 }, { s: 'feature set', w: 2 }, { s: 'offering', w: 2 }, { s: 'launch', w: 1 }, { s: 'produto', w: 3 }, { s: 'lançamento', w: 1 }, { s: 'lancamento', w: 1 } ],
    initiative: [ { s: 'initiative', w: 3 }, { s: 'program', w: 2 }, { s: 'migration program', w: 2 }, { s: 'rollout', w: 1 }, { s: 'iniciativa', w: 3 }, { s: 'programa', w: 2 }, { s: 'programa de migração', w: 2 }, { s: 'programa de migracao', w: 2 }, { s: 'implantação', w: 1 }, { s: 'implantacao', w: 1 } ],
    compliance: [ { s: 'compliance', w: 3 }, { s: 'lgpd', w: 2 }, { s: 'audit', w: 2 }, { s: 'regulatory', w: 2 }, { s: 'conformidade', w: 3 }, { s: 'auditoria', w: 2 }, { s: 'regulatório', w: 2 }, { s: 'regulatorio', w: 2 } ],
  } },
  operationKind: { default: 'change', kinds: {
    change: [ { s: 'add ', w: 2 }, { s: 'implement', w: 2 }, { s: 'feature', w: 2 }, { s: 'endpoint', w: 1 }, { s: 'component', w: 1 }, { s: 'adicionar', w: 2 }, { s: 'adicione', w: 2 }, { s: 'implementar', w: 2 }, { s: 'implemente', w: 2 }, { s: 'funcionalidade', w: 2 }, { s: 'componente', w: 1 } ],
    fix: [ { s: 'fix ', w: 3 }, { s: 'bug', w: 3 }, { s: 'broken', w: 2 }, { s: 'regression', w: 2 }, { s: 'hotfix', w: 3 }, { s: 'corrigir', w: 3 }, { s: 'corrija', w: 3 }, { s: 'quebrado', w: 2 } ],
    maintenance: [ { s: 'refactor', w: 2 }, { s: 'rename', w: 2 }, { s: 'bump', w: 2 }, { s: 'cleanup', w: 2 }, { s: 'lint', w: 1 }, { s: 'tidy', w: 1 }, { s: 'refatorar', w: 2 }, { s: 'renomear', w: 2 }, { s: 'limpeza', w: 2 } ],
    investigation: [ { s: 'investigate', w: 3 }, { s: 'diagnose', w: 3 }, { s: 'root cause', w: 3 }, { s: 'why ', w: 1 }, { s: 'audit', w: 1 }, { s: 'investigar', w: 3 }, { s: 'diagnosticar', w: 3 }, { s: 'causa raiz', w: 3 }, { s: 'auditoria', w: 1 } ],
    operationalresponse: [ { s: 'incident', w: 3 }, { s: 'outage', w: 3 }, { s: 'rollback', w: 2 }, { s: 'restore', w: 2 }, { s: 'recover', w: 2 }, { s: 'incidente', w: 3 }, { s: 'queda', w: 3 }, { s: 'restaurar', w: 2 }, { s: 'recuperar', w: 2 } ],
  } },
  valueIntent: { default: 'IMPROVE', secondaryMargin: 2, intents: {
    CREATE: [ { s: 'new ', w: 2 }, { s: 'build', w: 2 }, { s: 'create', w: 3 }, { s: 'add ', w: 1 }, { s: 'launch', w: 2 }, { s: 'novo ', w: 2 }, { s: 'nova ', w: 2 }, { s: 'construir', w: 2 }, { s: 'criar', w: 3 }, { s: 'crie', w: 3 }, { s: 'adicionar', w: 1 }, { s: 'lançar', w: 2 }, { s: 'lancar', w: 2 } ],
    PROTECT: [ { s: 'secure', w: 3 }, { s: 'harden', w: 3 }, { s: 'protect', w: 3 }, { s: 'prevent', w: 2 }, { s: 'vulnerab', w: 2 }, { s: 'proteger', w: 3 }, { s: 'reforçar', w: 3 }, { s: 'reforcar', w: 3 }, { s: 'prevenir', w: 2 }, { s: 'vulnerável', w: 2 }, { s: 'vulneravel', w: 2 } ],
    RECOVER: [ { s: 'fix ', w: 2 }, { s: 'restore', w: 3 }, { s: 'recover', w: 3 }, { s: 'rollback', w: 2 }, { s: 'incident', w: 2 }, { s: 'outage', w: 2 }, { s: 'corrigir', w: 2 }, { s: 'restaurar', w: 3 }, { s: 'recuperar', w: 3 }, { s: 'incidente', w: 2 }, { s: 'queda', w: 2 } ],
    ENABLE: [ { s: 'enable', w: 3 }, { s: 'unblock', w: 2 }, { s: 'foundation', w: 2 }, { s: 'infrastructure', w: 2 }, { s: 'platform', w: 2 }, { s: 'seam', w: 1 }, { s: 'capability', w: 3 }, { s: 'strategic', w: 2 }, { s: 'initiative', w: 2 }, { s: 'habilitar', w: 3 }, { s: 'desbloquear', w: 2 }, { s: 'fundação', w: 2 }, { s: 'fundacao', w: 2 }, { s: 'infraestrutura', w: 2 }, { s: 'plataforma', w: 2 }, { s: 'capacidade', w: 3 }, { s: 'estratégico', w: 2 }, { s: 'estrategico', w: 2 }, { s: 'iniciativa', w: 2 } ],
    IMPROVE: [ { s: 'improve', w: 3 }, { s: 'optimi', w: 2 }, { s: 'faster', w: 2 }, { s: 'refactor', w: 2 }, { s: 'polish', w: 1 }, { s: 'reduce', w: 1 }, { s: 'melhorar', w: 3 }, { s: 'otimi', w: 2 }, { s: 'mais rápido', w: 2 }, { s: 'mais rapido', w: 2 }, { s: 'refatorar', w: 2 }, { s: 'reduzir', w: 1 } ],
    LEARN: [ { s: 'investigate', w: 3 }, { s: 'research', w: 3 }, { s: 'spike', w: 2 }, { s: 'explore', w: 2 }, { s: 'diagnose', w: 2 }, { s: 'measure', w: 1 }, { s: 'investigar', w: 3 }, { s: 'pesquisar', w: 3 }, { s: 'pesquisa', w: 3 }, { s: 'explorar', w: 2 }, { s: 'diagnosticar', w: 2 }, { s: 'medir', w: 1 } ],
    COMPLY: [ { s: 'lgpd', w: 3 }, { s: 'compliance', w: 3 }, { s: 'consent', w: 2 }, { s: 'audit', w: 2 }, { s: 'regulatory', w: 3 }, { s: 'pii', w: 2 }, { s: 'conformidade', w: 3 }, { s: 'consentimento', w: 2 }, { s: 'auditoria', w: 2 }, { s: 'regulatório', w: 3 }, { s: 'regulatorio', w: 3 } ],
    SERVE_MISSION: [ { s: 'mission', w: 3 }, { s: 'open source', w: 2 }, { s: 'community', w: 2 }, { s: 'accessib', w: 2 }, { s: 'missão', w: 3 }, { s: 'missao', w: 3 }, { s: 'comunidade', w: 2 } ],
  } },
  growthLever: { default: null, levers: {
    STRATEGIC_ENABLEMENT: [ { s: 'platform', w: 2 }, { s: 'enable', w: 2 }, { s: 'forecast', w: 2 }, { s: 'portfolio', w: 3 }, { s: 'foundation', w: 2 }, { s: 'capability', w: 2 }, { s: 'plataforma', w: 2 }, { s: 'habilitar', w: 2 }, { s: 'portfólio', w: 3 }, { s: 'fundação', w: 2 }, { s: 'fundacao', w: 2 }, { s: 'capacidade', w: 2 } ],
    OPERATIONAL_EFFICIENCY: [ { s: 'ceremony', w: 3 }, { s: 'automate', w: 2 }, { s: 'faster', w: 2 }, { s: 'batch', w: 2 }, { s: 'workflow', w: 1 }, { s: 'reduce friction', w: 3 }, { s: 'export', w: 2 }, { s: 'endpoint', w: 1 }, { s: 'report', w: 1 }, { s: 'automatizar', w: 2 }, { s: 'mais rápido', w: 2 }, { s: 'mais rapido', w: 2 }, { s: 'em massa', w: 2 }, { s: 'reduzir atrito', w: 3 }, { s: 'exportar', w: 2 }, { s: 'relatório', w: 1 }, { s: 'relatorio', w: 1 } ],
    QUALITY: [ { s: 'test', w: 2 }, { s: 'validate', w: 2 }, { s: 'coverage', w: 2 }, { s: 'correct', w: 2 }, { s: 'review', w: 1 }, { s: 'lint', w: 1 }, { s: 'harden', w: 2 }, { s: 'self-approve', w: 2 }, { s: 'recorded', w: 1 }, { s: 'validar', w: 2 }, { s: 'cobertura', w: 2 }, { s: 'correção', w: 2 }, { s: 'correcao', w: 2 }, { s: 'revisão', w: 1 }, { s: 'revisao', w: 1 }, { s: 'reforçar', w: 2 }, { s: 'reforcar', w: 2 } ],
    COST_EFFICIENCY: [ { s: 'cost', w: 3 }, { s: 'token', w: 2 }, { s: 'quota', w: 2 }, { s: 'budget', w: 2 }, { s: 'cache', w: 1 }, { s: 'custo', w: 3 }, { s: 'orçamento', w: 2 }, { s: 'orcamento', w: 2 } ],
    RELIABILITY: [ { s: 'idempotent', w: 2 }, { s: 'deterministic', w: 2 }, { s: 'rebuild', w: 2 }, { s: 'stable', w: 1 }, { s: 'registry', w: 1 }, { s: 'regression', w: 2 }, { s: 'rollback', w: 2 }, { s: 'updater', w: 2 }, { s: 'guard', w: 2 }, { s: 'worktree', w: 1 }, { s: 'across the repo', w: 2 }, { s: 'determinístico', w: 2 }, { s: 'deterministico', w: 2 }, { s: 'estável', w: 1 }, { s: 'estavel', w: 1 }, { s: 'entre o repositório', w: 2 }, { s: 'entre o repositorio', w: 2 } ],
  } },
  executionMode: {
    default: 'direct',
    ...
    modes: {
      workflow: [ { s: 'multi-step', w: 3 }, { s: 'several phases', w: 3 }, { s: 'wave', w: 2 }, { s: 'milestones', w: 2 }, { s: 'across modules', w: 2 }, { s: 'program', w: 2 }, { s: 'epic', w: 2 }, { s: 'várias etapas', w: 3 }, { s: 'multi-etapa', w: 3 }, { s: 'várias fases', w: 3 }, { s: 'onda', w: 2 }, { s: 'marcos', w: 2 }, { s: 'entre módulos', w: 2 }, { s: 'entre modulos', w: 2 }, { s: 'programa', w: 2 }, { s: 'épico', w: 2 }, { s: 'epico', w: 2 } ],
      batch: [ { s: 'all ', w: 1 }, { s: 'every ', w: 2 }, { s: 'bulk', w: 3 }, { s: 'across the', w: 2 }, { s: 'each ', w: 1 }, { s: 'sweep', w: 2 }, { s: 'rename all', w: 3 }, { s: 'a few', w: 2 }, { s: 'warnings', w: 1 }, { s: 'todos ', w: 1 }, { s: 'todas ', w: 1 }, { s: 'cada ', w: 1 }, { s: 'em massa', w: 3 }, { s: 'varredura', w: 2 }, { s: 'renomear tudo', w: 3 }, { s: 'poucos', w: 2 }, { s: 'avisos', w: 1 } ],
      direct: [ { s: 'fix ', w: 1 }, { s: 'one ', w: 1 }, { s: 'single', w: 2 }, { s: 'quick', w: 1 }, { s: 'corrigir ', w: 1 }, { s: 'um ', w: 1 }, { s: 'único', w: 2 }, { s: 'unico', w: 2 }, { s: 'rápido', w: 1 }, { s: 'rapido', w: 1 } ],
    },
