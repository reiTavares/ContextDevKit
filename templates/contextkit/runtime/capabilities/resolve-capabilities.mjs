  ...
  capabilities: [
    {
      ...
      aliases: { claude: '/state', codex: 'cdx state', agy: 'agy state', grok: 'node contextkit/tools/scripts/context-pack.mjs' },
      minLevel: 1,
    ...
    },
    {
      ...
      kind: 'public',
      entrypoint: 'contextkit/tools/scripts/context-pack.mjs',
      aliases: { claude: '/context-pack', codex: 'cdx context-pack', agy: 'agy context-pack', grok: 'node contextkit/tools/scripts/context-pack.mjs' },
      minLevel: 3,
    ...
    },
    {
      ...
      aliases: { claude: '/project-map', codex: 'cdx project-map', agy: 'agy project-map', grok: 'node contextkit/tools/scripts/project-map.mjs' },
      minLevel: 3,
      appliesWhen: { tiers: ['feature', 'architectural'], domains: ['*'], paths: ['*'], phases: ['*'] },
      prerequisites: [],
      requiredMoment: 'beforeExploration',
    ...
    },
    {
      ...
      aliases: { claude: '/workflow', codex: 'cdx workflow', agy: 'agy workflow', grok: 'node contextkit/tools/scripts/workflow.mjs' },
      minLevel: 3,
      appliesWhen: { tiers: ['feature', 'architectural'], domains: ['*'], paths: ['*'], phases: ['*'] },
      prerequisites: [],
    ...
    },
    {
      ...
      aliases: { claude: '/dev-start', codex: 'cdx pipeline dev-start', agy: 'agy dev-start', grok: 'node contextkit/tools/scripts/sync-check.mjs' },
      minLevel: 2,
      appliesWhen: { tiers: ['feature', 'architectural'], domains: ['*'], paths: ['*'], phases: ['*'] },
      prerequisites: [],
      requiredMoment: 'beforeWrite',
    ...
    },
    {
      ...
      aliases: { claude: '/simulate-impact', codex: 'cdx simulate-impact', agy: 'agy simulate-impact', grok: 'node contextkit/tools/scripts/mark-simulation.mjs' },
      minLevel: 5,
    ...
    },
    {
      ...
      aliases: { claude: '/test-plan', codex: 'cdx qa test-plan', agy: 'agy test-plan', grok: 'node contextkit/tools/scripts/scaffold-tests.mjs' },
      minLevel: 4,
      appliesWhen: { tiers: ['feature', 'architectural'], domains: ['*'], paths: ['*'], phases: ['*'] },
      prerequisites: [],
    ...
    },
    {
      ...
      kind: 'public',
      entrypoint: 'npm test',
      aliases: { claude: 'npm test', codex: 'npm test', agy: 'npm test', grok: 'npm test' },
      minLevel: 1,
      appliesWhen: { tiers: ['feature', 'architectural'], domains: ['*'], paths: ['*'], phases: ['*'] },
      prerequisites: [],
      requiredMoment: 'beforeCompletion',
    ...
    },
    {
      ...
      aliases: { claude: '/qa-signoff', codex: 'cdx qa qa-signoff', agy: 'agy qa-signoff', grok: 'node contextkit/tools/scripts/ship-state.mjs' },
      minLevel: 4,
      appliesWhen: { tiers: ['feature', 'architectural'], domains: ['*'], paths: ['*'], phases: ['*'] },
    ...
    },
    {
      ...
      aliases: { claude: '/log-session', codex: 'cdx log-session', agy: 'agy log-session', grok: 'node contextkit/tools/scripts/session-draft.mjs' },
      minLevel: 2,
      appliesWhen: { tiers: ['*'], domains: ['*'], paths: ['*'], phases: ['*'] },
      prerequisites: [],
      requiredMoment: 'beforeCompletion',
