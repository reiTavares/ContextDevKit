...
`<body><div id="root"><the `div` skill><the `body` skill>` and the rest is JS.
...
<div class="article">
  <div class="header">
    <div class="title">Why X matters<the `div` skill>
  <the `div` skill>
  <div class="content">...<the `div` skill>
<the `div` skill>
```
