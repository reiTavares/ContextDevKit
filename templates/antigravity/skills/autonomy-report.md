# Skill: autonomy-report

> Show or verify a stored Session Autonomy Receipt (token/autonomy/cost) for a session.
# the `autonomy-report` skill — Session Autonomy Receipt viewer
