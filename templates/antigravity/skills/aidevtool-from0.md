# Skill: aidevtool-from0

> Bootstrap a brand-new (empty) project from zero — product idea, interactive questionnaire, stack suggestion, roadmap, best practices.
> Argument: [one-line idea]
...
Offer to adopt the vibe-coding best practices in `contextkit/best-practices.md`
