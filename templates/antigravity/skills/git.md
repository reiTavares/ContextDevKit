...
> Version-control command — git workflow + connect a remote (GitHub/GitLab/other) with the CLI, fully integrated.
> Argument: [status | setup-remote | new-branch <name> | commit | pr | sync | release]
# 🔧 Git / Version Control
