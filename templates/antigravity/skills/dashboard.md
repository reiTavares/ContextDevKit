...
> Visual dashboard — pipeline lanes + ADRs + sessions + roadmap + CHANGELOG. Snapshot HTML by default; live SSE-driven view with --watch.
> Argument: [--watch] [--port=N] [--out=PATH]
# 📊 Dashboard
