...
> Fleet mode — one control plane over many ContextDevKit repos (portfolio stats, cross-repo audit, CLAUDE.md rule-drift).
> Argument: [list | add <path> | remove <path> | stats | audit | propagate <rule-file>]
