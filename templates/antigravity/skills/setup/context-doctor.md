...
> Diagnose this project's ContextDevKit install (node, config, hook wiring, git hooks, onboarding).
> ⚠️ **Deprecated (1.0):** **the `audit` skill** runs the doctor *plus* stats, tech-debt and
