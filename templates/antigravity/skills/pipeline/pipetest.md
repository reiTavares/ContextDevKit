...
> Deterministic QA gate for explicitly scoped canonical testing tasks.
> Argument: <taskId …> --tasks <scope> | --all --tasks <scope>
# 🧪 Pipetest (deterministic testing-lane gate)

Targets: **<user-specified argument>** (task ids whose canonical status is `testing`, or
