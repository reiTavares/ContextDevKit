...
> Domain-modeling specialist for bounded contexts, language, invariants, aggregates, state authority, and transactional boundaries. Recommend for genuinely domain-heavy work; never make this specialist a write prerequisite. (devteam squad)
