---
name: "source-command-tune-agents"
...
# source-command-tune-agents

Use this skill when the user asks to run the migrated source command `tune-agents`.
...
**apply nothing**. This is the review step (like `/distill-sessions` for `AGENTS.md`);
