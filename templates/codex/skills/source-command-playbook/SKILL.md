---
name: "source-command-playbook"
description: "Playbook registry + runner — list/show/run/track the reusable procedures in contextkit/workflows/playbooks/."
---

# source-command-playbook

Use this skill when the user asks to run the migrated source command `playbook`.
...
detail belongs in a scoped `AGENTS.md` or an ADR.
