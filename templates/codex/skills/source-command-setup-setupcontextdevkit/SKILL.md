...
2. Read `README*`, the existing `AGENTS.md`, and skim the top-level structure to
...
## Phase 4 — Fill in AGENTS.md
Edit `AGENTS.md` (or merge `CLAUDE.contextdevkit.md` if the installer left one):
...
- At **level ≥ 4** the squads install (`.codex/agents/`): **devteam**, **qa-team**,
...
important/high-risk paths), AGENTS.md sections filled, agents created, deps
