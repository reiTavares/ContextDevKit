---
name: "source-command-audit-validate-doc"
...
# source-command-audit-validate-doc

Use this skill when the user asks to run the migrated source command `validate-doc`.
