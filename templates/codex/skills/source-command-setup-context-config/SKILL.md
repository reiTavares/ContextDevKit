---
name: "source-command-setup-context-config"
description: "Inspect or edit contextkit/config.json (ledger path lists, L5 high-risk paths, distill params)."
---

# source-command-setup-context-config

Use this skill when the user asks to run the migrated source command `context-config`.
