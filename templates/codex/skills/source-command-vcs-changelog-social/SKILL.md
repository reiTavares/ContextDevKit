---
name: "source-command-vcs-changelog-social"
...
# source-command-vcs-changelog-social

Use this skill when the user asks to run the migrated source command `changelog-social`.
