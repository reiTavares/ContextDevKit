---
name: "source-command-simulate-impact"
description: "L5 pre-flight — map the blast radius of a change BEFORE editing high-risk paths."
---

# source-command-simulate-impact

Use this skill when the user asks to run the migrated source command `simulate-impact`.
...
3. **Materialize the reviewed prediction** with the explicit write flag:
   ```
   node contextkit/tools/scripts/mark-simulation.mjs --write "$ARGUMENTS" <covered-path-or-dir/> [more ...]
   ```
