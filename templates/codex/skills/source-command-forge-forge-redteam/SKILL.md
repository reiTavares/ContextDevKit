---
name: "source-command-forge-forge-redteam"
...
# source-command-forge-forge-redteam

Use this skill when the user asks to run the migrated source command `forge-redteam`.
